"""导出 附录D_challenge_appendix_d.md → .docx"""
...
SRC = Path(__file__).resolve().parents[1] / "evidence" / "challenge_appendix_d.md"
OUT = Path(r"c:\Users\咸\Desktop\文档\附录D-挑战赛增量案例验证.docx")
FALLBACK = Path(r"c:\Users\咸\Desktop\文档\附录D-挑战赛增量案例验证_new.docx")
